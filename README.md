...
처음 해보는 풀스택 프로젝트여서 모르는 점도 많고, 부족한 점도 많았던 것 같다. 하지만 그 과정에서 많이 배웠고 앞으로 더 발전할 수 있었던 것 같다. 프론트엔드와 백엔드를 모두 경험해보면서 더욱 웹 개발을 공부해보고 싶다는 생각이 들었다. 이 프로젝트를 통해 더욱 열심히 공부하고, 더욱 발전하는 개발자가 되고 싶다.
